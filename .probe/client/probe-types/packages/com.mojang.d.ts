...
import {$PoseStackAccessor as $PoseStackAccessor$0, $PoseStackAccessor$Type as $PoseStackAccessor$0$Type} from "packages/org/embeddedt/modernfix/common/mixin/bugfix/entity_pose_stack/$PoseStackAccessor"
...
export class $PoseStack implements $IForgePoseStack, $CachingPoseStack, $PoseStackAccessor$0, $PoseStackAccessor, $PoseStackExtension {
...
export class $BufferBuilder extends $DefaultedVertexConsumer implements $BufferVertexConsumer, $BufferBuilderAccessor, $IBufferBuilder, $ExtendedBufferBuilder, $VertexBufferWriter {
...
(): $Function10<(T1), (T2), (T3), (T4), (T5), (T6), (T7), (T8), (T9), (T10), ($Function<(T11), (R)>)>
}
...
(): $Function10<(T1), (T2), (T3), (T4), (T5), (T6), (T7), (T8), (T9), (T10), ($Function5<(T11), (T12), (T13), (T14), (T15), (R)>)>
}
...
(): $Function10<(T1), (T2), (T3), (T4), (T5), (T6), (T7), (T8), (T9), (T10), ($Function4<(T11), (T12), (T13), (T14), (R)>)>
}
...
(): $Function10<(T1), (T2), (T3), (T4), (T5), (T6), (T7), (T8), (T9), (T10), ($Function3<(T11), (T12), (T13), (R)>)>
}
...
(): $Function10<(T1), (T2), (T3), (T4), (T5), (T6), (T7), (T8), (T9), (T10), ($BiFunction<(T11), (T12), (R)>)>
}
...
import {$IMixinBlendMode, $IMixinBlendMode$Type} from "packages/de/keksuccino/fancymenu/mixin/mixins/common/client/$IMixinBlendMode"

export class $BlendMode implements $IMixinBlendMode {
...
import {$Matrix4f, $Matrix4f$Type} from "packages/org/joml/$Matrix4f"
import {$VertexFormat, $VertexFormat$Type} from "packages/com/mojang/blaze3d/vertex/$VertexFormat"
import {$VertexBufferAccessor, $VertexBufferAccessor$Type} from "packages/com/qendolin/betterclouds/mixin/runtime/$VertexBufferAccessor"

export class $VertexBuffer implements $AutoCloseable, $VertexBufferAccessor {
...
import {$IMixinNativeImage, $IMixinNativeImage$Type} from "packages/de/keksuccino/fancymenu/mixin/mixins/common/client/$IMixinNativeImage"
...
public "handler$cfb000$getGuiScaledWidth"(arg0: $CallbackInfoReturnable$Type<(any)>): void
public "handler$cfb000$getGuiScaledHeight"(arg0: $CallbackInfoReturnable$Type<(any)>): void
public "getX"(): integer
public "getY"(): integer
public "handler$cfb000$getGuiScale"(arg0: $CallbackInfoReturnable$Type<(any)>): void
