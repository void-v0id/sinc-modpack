...
import {$TimelessItemWrapper, $TimelessItemWrapper$Type} from "packages/com/tacz/guns/compat/kubejs/util/$TimelessItemWrapper"
...
import {$GunProperties, $GunProperties$Type} from "packages/com/tacz/guns/api/$GunProperties"
...
import {$TaCZJSUtils, $TaCZJSUtils$Type} from "packages/dev/aika/taczjs/forge/$TaCZJSUtils"
...
const TaCZJSUtils: typeof $TaCZJSUtils
