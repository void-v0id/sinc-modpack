...
public "handler$efl000$supp$tomatoLoggingCompat"(level: $ServerLevel$Type, pos: $BlockPos$Type, random: $RandomSource$Type, ci: $CallbackInfo$Type): void
public "wrapOperation$efl000$supp$tomatoLoggingCompat2"(state: $BlockState$Type, block: $Block$Type, operation: $Operation$Type<(any)>): boolean
