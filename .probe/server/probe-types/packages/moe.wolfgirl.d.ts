...
import {$InputItem, $InputItem$Type} from "packages/dev/latvian/mods/kubejs/item/$InputItem"
import {GunSmithTableCrafting, GunSmithTableCrafting$Type} from "packages/moe/wolfgirl/probejs/generated/schema/tacz/GunSmithTableCrafting"
...
import {Crushing, Crushing$Type} from "packages/moe/wolfgirl/probejs/generated/schema/occultism/Crushing"
...
export class DocumentedRecipes {
 ...
 "mekanismtools": {}
 "occultism": {spirit_trade(result: $OutputItem$Type, ingredients: ($InputItem$Type)[]): SpiritTrade, crushing(result: $OutputItem$Type, ingredient: $InputItem$Type, crushingTime?: (number) | (string), minTier?: number, ignoreCrushingMultiplier?: boolean): Crushing, spirit_fire(result: $OutputItem$Type, ingredient: $InputItem$Type): SpiritFire, ritual(result: $OutputItem$Type, ingredients: ($InputItem$Type)[], activationItem: $InputItem$Type, pentacleId: string, duration?: number, maxAge?: number, jobType?: string, dummyItem?: $OutputItem$Type, ritualType?: string, entityToSummon?: string, entityNbt?: string, sacrifice?: {"tag": string, "display_name": string}, useItem?: $InputItem$Type, command?: string): Ritual, miner(result: $OutputItem$Type, ingredient: $InputItem$Type): Miner}
 "ars_nouveau": {}
 "forge": {}
 "supplementaries": {}
 "mob_grinding_utils": {}
...
declare module "packages/moe/wolfgirl/probejs/generated/schema/tacz/GunSmithTableCrafting" {
import {$TimelessRecipeJS, $TimelessRecipeJS$Type} from "packages/com/tacz/guns/compat/kubejs/recipe/$TimelessRecipeJS"
import {$InputItem, $InputItem$Type} from "packages/dev/latvian/mods/kubejs/item/$InputItem"
import {$GunSmithTableResultInfo, $GunSmithTableResultInfo$Type} from "packages/com/tacz/guns/compat/kubejs/util/$GunSmithTableResultInfo"
 ...
 */
declare global {
export type GunSmithTableCrafting_ = GunSmithTableCrafting$Type;
}}
