...
import {$ItemStack, $ItemStack$Type} from "packages/net/minecraft/world/item/$ItemStack"
import {$JsonSerializable, $JsonSerializable$Type} from "packages/dev/latvian/mods/rhino/mod/util/$JsonSerializable"
import {$IngredientKJSMixin, $IngredientKJSMixin$Type} from "packages/dev/uncandango/alltheleaks/mixin/core/main/$IngredientKJSMixin"
...
public "handler$cml000$loadJavaClass"(name0: string, warn: boolean, cir: $CallbackInfoReturnable$Type<(any)>): void
