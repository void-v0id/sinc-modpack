...
(arg0: $Supplier$Type<(T)>): $NonNullSupplier<(T)>
}
...
(arg0: string, arg1: $ResourceKey$Type<(any)>, arg2: $Builder$Type<(R), (T), (any), (any)>, arg3: $NonNullSupplier$Type<(any)>): $RegistryEntry<(T)>
}
